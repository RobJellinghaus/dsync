...
pub struct TableOptions<'a> {
    ...
    #[cfg(feature = "graphql")]
    /// Adds async_graphql derives for GraphQL support (see <https://github.com/async-graphql/async-graphql>)
    graphql: Option<bool>,
...
impl<'a> TableOptions<'a> {
    ...
    #[inline]
    #[cfg(feature = "graphql")]
    pub fn get_graphql(&self) -> bool {
        self.graphql.unwrap_or_default()
    }
